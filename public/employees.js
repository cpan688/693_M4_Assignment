...
function EmployeeRow(props) {
  // const employee = props.employee // this is no longer needed, since props is being passed in
  // instead use props. object reference below
...
class EmployeeList extends React.Component {
  ...
  // Add deleteEmployee function here
  deleteEmployee(id) {
